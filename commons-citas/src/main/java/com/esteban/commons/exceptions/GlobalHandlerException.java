package com.esteban.commons.exceptions;

import com.esteban.commons.dto.ErrorResponse;
...
public class GlobalHandlerException {
    ...
    public ResponseEntity<ErrorResponse> handleConstraintViolationException(ConstraintViolationException e) {
        ...
        return ResponseEntity.badRequest().body(new ErrorResponse(HttpStatus.BAD_REQUEST.value(), "Violación de restricción: " + e.getMessage()));
    }
